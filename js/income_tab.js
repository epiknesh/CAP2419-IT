         ...
         <table>
          <thead>
            <tr>
              ...
              <th>Estimated Income Today <i id="sort-estimatedIncomeToday-dailyIncome" class="bi bi-sort-up fs-5 ms-2 text-secondary" style="cursor: pointer;"></i>
...
function attachDailyIncomeSortListeners() {
  ...
  const sortIcons = {
    ...
    2: document.getElementById("sort-estimatedIncomeToday-dailyIncome"),
  ...
  const getCellValue = (row, columnIndex) => {
    ...
    if (columnIndex === 1 || columnIndex === 2) {
      // Income Today or Estimated Income Today
  ...
  document.getElementById("sort-estimatedIncomeToday-dailyIncome").addEventListener("click", () => sortTable(2));
